"""
11주차 실습: 자율주행 경로 추종 시뮬레이션 비교 (Pure Pursuit vs Stanley)
- 두 제어 알고리즘의 궤적 및 조향 특성 동시 비교
- 애니메이션 재생 속도 3배속 적용
"""
...
def main():
    # S자 커브 (곡률을 좀 더 강하게 주어 차이를 명확히 함)
    ...
    while target_ind_pp < len(cx) - 1 or target_ind_st < len(cx) - 1:
        ...
        if step % 3 == 0:
            ...
            # 애니메이션 정지 시간 최소화로 더 부드럽고 빠른 진행 유도
            plt.pause(0.001)
